...
## What are Costs and Risks?
 ...
 It is the amount of money spent on a specific activity or resource. There are two types of costs involved in service relationships. 
 - One is cost removed from the consumer by the service.
 - The other one is cost imposed on the consumer by the service.
 
 Cost involves the money spent on service components like hardware, software, facility, people services, etc., which are essential for a service. Besides, from the perspective of the customer, while the services incur cost during its life cycle for the consumption of the service, it also removes certain costs by utilizing the services. Let's look at an example. For the HR portal services, the service components or website, hosting server, Internet, data center, skill people, etc, where these are the cost components incurred by the organization, whereas the cost associated with printing, travel to submit the claim, cost impact due to impact productivity, etc. Now let's look at risk. The definition for risk is a possible event that could cause harm or loss or make it more difficult to achieve objectives. Can also be defined as uncertainty of outcome, and can be used in the context of measuring the probability of positive outcomes as well as negative outcomes. Identification of the risk, assessing, and analyzing, defining and implementing a risk response throughout the life cycle of a service is essential. Risk is assessed qualitatively and quantitatively. The qualitative risk analysis is done by checking the probability and impact of the risk by defining the probability and impact matrix. Whereas, the quantitative risk analysis checks the risk, impact by quantifying it with a specific cost of impact. In the example of HR portal for claim processing, risk removed can be delay in submission and processing claims, impact on productivity, employee dissatisfaction, etc. Whereas, the risk introduced can be unavailability of the HR portal, degraded performance, and time taken by an employee to get used to portal environment, etc.
