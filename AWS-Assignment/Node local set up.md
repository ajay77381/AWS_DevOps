...
nvm -current 
```
Note- nvm -current  - Show the current activated version.
```
nvm ls-remote
```
Note- nvm ls-remote - show the available version of node. 
```
nvm install v22.3.0
```

nvm install v22.3.0 - To install a particular version 
```
node -v
````
node -v To show the version of node.
